...
# Get CLI version
with open(Path(Path.cwd() / 'util') / 'setup.py', 'r') as f:
    for line in f:
        if line.startswith('VERSION'):
            ...
            if match:
                ...
                cli_name = 'util-{}-py2.py3-none-any.whl'.format(cli_version)

version = f'v{cli_version}'

download_url = f'https://github.com/colbylwilliams/az-util/releases/download/{version}' if ci else assets_dir
            ...
            'metadata': {
                ...
                'extensions': {
                    'python.details': {
                        ...
                        'project_urls': {
                            'Home': 'https://github.com/colbylwilliams/az-util'
                        }
                    }
                },
                ...
                'name': 'util',
                'summary': 'Microsoft Azure Command-Line Tools Util Extension',
